        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
           <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-brand-green">
              <div className="flex items-center gap-3 mb-3">
                 <Icon name="Users" className="text-brand-green" />
                 <h3 className="font-bold text-lg text-gray-900">Integrated Model of Care</h3>
              </div>
              <p className="text-sm text-gray-600">
                 We don't simply offer a bed. We combine psychosocial rehabilitation with income-generating agricultural projects and accredited training under one roof.
              </p>
           </div>

           <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-brand-blue">
              <div className="flex items-center gap-3 mb-3">
                 <Icon name="Home" className="text-brand-blue" />
                 <h3 className="font-bold text-lg text-gray-900">Development-Oriented Centres</h3>
              </div>
              <p className="text-sm text-gray-600">
                 Our facilities go beyond shelter—they are hubs of transformation where learning, healing, and productivity take place simultaneously.
              </p>
           </div>

           <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-brand-earth">
              <div className="flex items-center gap-3 mb-3">
                 <Icon name="Heart" className="text-brand-earth" />
                 <h3 className="font-bold text-lg text-gray-900">From Trauma to Transformation</h3>
              </div>
              <p className="text-sm text-gray-600">
                 Our programmes are designed to move individuals from trauma into dignity, and from crisis into cooperative participation and self-sufficiency.
              </p>
           </div>

           <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-yellow-500">
              <div className="flex items-center gap-3 mb-3">
                 <Icon name="GraduationCap" className="text-yellow-600" />
                 <h3 className="font-bold text-lg text-gray-900">Market-Linked Reskilling</h3>
              </div>
              <p className="text-sm text-gray-600">
                 We align youth and adult upskilling with real economic opportunities in sectors such as artisan baking, regenerative agriculture, and green manufacturing.
              </p>
           </div>
           ...
           <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-red-500">
              <div className="flex items-center gap-3 mb-3">
                 ...
                 <h3 className="font-bold text-lg text-gray-900">No Exclusion Policy</h3>
              </div>
              <p className="text-sm text-gray-600">
                 We intake without discrimination. We welcome those with profound life disruptions, offering a stabilizing environment rooted in accountability and compassionate care.
              </p>
           </div>
        </div>
      </Section>
      ...
      <Section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {CORE_VALUES.map((value, idx) => (
            <div key={idx} className="bg-brand-sand p-6 rounded-lg shadow-sm text-center hover:shadow-md transition border border-transparent hover:border-brand-green/20">
